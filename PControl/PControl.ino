...
// Distance sensor
#define _DIST_ALPHA 0.7  //[3099] EMA 필터링을 위한 alpha 값
               // [3108] 0~1 사이의 값
#define SEQ_SIZE 14

// Servo range
#define _DUTY_MIN 800     //[3100] 최저 서보 위치
#define _DUTY_NEU 1600   //[3100] 중립 서보 위치
...
// sensor values
float x[SEQ_SIZE] = {72.86, 94.80, 116.69, 135.19, 155.43, 176.59, 202.66, 211.41, 249.44, 260.50, 286.18, 303.23, 324.69, 339.97};
// real values
